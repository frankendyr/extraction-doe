# -*- coding: utf-8 -*-
"""Extraction_DOE_API (Versão Para FastAPI)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1COZ45QThtTMUFQI2W4Q8pjO2zCjPcq49

#00 - Configuração e instalações
"""
...
# ==============================================================================
# 2. CONFIGURAÇÕES GLOBAIS E AUTENTICAÇÕES
# ==============================================================================
...
"""#02 - Funções de Persistência de Dados"""

# Commented out IPython magic to ensure Python compatibility.
#***************************************************************************
def obter_conexao_banco():
    """
    Fábrica de conexões isolada para o banco de homologação/desenvolvimento.
    """
    return psycopg2.connect(
        host="18.206.213.53",
        port=5432,
        dbname="db_versionamento_desenvolvimento",
        user="servico_extracao",
        password="servico_extracao_h5sg4fd2ty5sd"
    )
...
#***************************************************************************
# ==============================================================================
# 1. CREDENCIAIS E CONFIGURAÇÕES DO MINIO
# ==============================================================================
def obter_configuracoes_minio() -> dict:
    ...
    """
    return {
        "endpoint_url": "http://18.206.213.53:9010",
        "access_key": "admin_extraction",
        "secret_key": "SenhaForteAqui123!",
        "bucket_name": "extraction-casa-civil"
    }

# ==============================================================================
# 2. FUNÇÕES BASE DO MINIO
# ==============================================================================
...
# ==============================================================================
# 3. FUNÇÃO DESACOPLADA DE UPLOAD
# ==============================================================================
def enviar_imagens_minio(numero_decreto: str, xrefs: list) -> list:
    if not xrefs:
        return []
